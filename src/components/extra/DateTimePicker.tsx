...
const TimePeriodSelect = (
  { ref, period, setPeriod, date, onDateChange, onLeftFocus, onRightFocus }: PeriodSelectorProps & { ref?: React.RefObject<HTMLButtonElement | null> },
) => {
...
const TimePickerInput = (
  { ref, className, type = 'tel', value, id, name, date = new Date(new Date().setHours(0, 0, 0, 0)), onDateChange, onChange, onKeyDown, picker, period, onLeftFocus, onRightFocus, ...props }: TimePickerInputProps & { ref?: React.RefObject<HTMLInputElement | null> },
) => {
...
const TimePicker = ({ ref, date, onChange, hourCycle = 24, granularity = 'second' }: TimePickerProps & { ref?: React.RefObject<TimePickerRef | null> }) => {
...
const DateTimePicker = (
  { ref, locale = ja, value, onChange, hourCycle = 24, yearRange = 50, disabled = false, displayFormat, granularity = 'second', placeholder = 'Pick a date', className, ...props }: DateTimePickerProps & { ref?: React.RefObject<Partial<DateTimePickerRef> | null> },
) => {
